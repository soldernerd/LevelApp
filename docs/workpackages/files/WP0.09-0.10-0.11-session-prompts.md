...
and the work package to implement is in `docs/workpackages/WP0.09-ci-pipeline.md`.
Please read both before starting any work.

We are implementing Work Package 0.09 — CI/CD Pipeline (target v0.9.0).
...
I'm building LevelApp — a C# WinUI 3 Windows app for precision level
measurement evaluation. The architecture document is in `docs/architecture.md`
and the work package to implement is in `docs/workpackages/WP0.10-auto-update.md`.
Please read both before starting any work.

We are implementing Work Package 0.10 — Auto-Update (target v0.10.0).
...
I'm building LevelApp — a C# WinUI 3 Windows app for precision level
measurement evaluation. The architecture document is in `docs/architecture.md`
and the work package to implement is in `docs/workpackages/WP0.11-replay-tests.md`.
Please read both before starting any work.

We are implementing Work Package 0.11 — Replay Tests (target v0.11.0).
